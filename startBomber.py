...
def get_number():
    ...
    while True:
        try:
            number = int(input(f"""
 ____  __  __ ____  _                     _              _____ ____
/ ___||  \/  / ___|| |__   ___  _ __ ___ | |__   ___ _ _|_   _|  _ \
\___ \| |\/| \___ \| '_ \ / _ \| '_ ` _ \| '_ \ / _ \ '__|| | | |_) |
 ___) | |  | |___) | |_) | (_) | | | | | | |_) |  __/ |   | | |  _ <
|____/|_|  |_|____/|_.__/ \___/|_| |_| |_|_.__/ \___|_|   |_| |_| \_\ by Mirzaga1001                      
 
   HEDEFİN NUMARİSİNİ GİRİN : 
  ...
  ÖRNEK"53xxxxxxxx" \n[?] : """))
            if len(str(number)) == 10 and str(number)[0] == "5":
                ...
                clear()
                print(f"Yanlış Numara Biçimi Girdin.")
        except:
            clear()
    ...
    while True:
        try:
            ...
            if amount >= 0:
                ...
                clear()
                print(f"Girdigin Sayı 0 Dan Küçük.")
        except:
            clear()
    ...
    while True:
        try:
            ...
            if worker_amount >= 1:
                ...
                clear()
                print(f"Girilen Sayı 1 Den Küçük.")
        except:
            clear()
            print(f"Sayı Gir.")
...
def restart():
    global clear
    while True:
        question = input(f"Programdan Çıkılsınmı.\n[Y/N] : ").upper().replace(" ", "")
        if question == "Y":
            quit()
        elif question == "N":
            clear()
            ...
            clear()
            print(f"Yanlış Tuşa Bastın  mal kardesim.")
